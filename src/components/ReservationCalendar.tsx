...
import { Calendar, Clock, Users, MapPin, Eye, Phone, Mail, User, Hash } from 'lucide-react';
...
function TimeSlot({
  ...
  const { otherUsers, isLocked } = useSlotPresence(table.venue_id, table.id, date, time);
  ...
  return (
    <div className="relative">
      ...
      >
        <button
          onClick={onSelect}
          disabled={isBooked || isLocked || isBeingBooked}
            ...
            <div className="mb-6">
              ...
              <div className="flex items-center gap-4 text-sm">
                ...
                <div className="flex items-center gap-2">
                  ...
                  <span className="text-slate-600">Being Viewed</span>
                </div>
                <div className="flex items-center gap-2">
